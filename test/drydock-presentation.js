...
const expected={fwd:[1,2,3],aft:[4,5,6],p:[6,1],s:[3,4],fs:[2,3],fp:[1,2],sa:[4,5],pa:[5,6],f:[2],a:[5],bow:[6,1,2,3,4],stern:[3,4,5,6,1],all:[1,2,3,4,5,6]};
...
assert.equal(arcLabel([3,4],t.arcs),'starboard (3,4)');
...
console.log(`Drydock presentation passed: 13 named arcs, 6 face names, ${checks} symmetric grid checks, independent mirrored placements.`);
