...
//
//   node test/record-battle.js --a EAR --b KRE --points 52 \
...
// strike cruiser at every size, so no replay ever contained a gunstar-battlecruiser or a
...
const points = Number(value("--points", "52"));
