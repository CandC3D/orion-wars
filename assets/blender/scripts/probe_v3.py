...
SRC = os.path.join(ROOT, "assets", "models", "v3")
FILES = ["Earth Monoceros Class Frigate v3.glb", "Earth Victory Class Destroyer v3.glb", "Earth Missile Destroyer v3 Series [NEW].glb", "Earth Corvette v3 Series [NEW].glb"]
for fn in FILES:
